...
- `prompt_id`: `plan22.review_candidate.v1`
...
- `non_goals`: Do not author, repair, mutate, rank, select, or promote; do not
  inspect sibling candidates or prior verdicts; do not replace external review;
  do not inspect rendered media.
...
- `excluded_context`: Author history, sibling candidates, population fitness,
  parent dispositions, prior internal/external results, protected holdouts,
