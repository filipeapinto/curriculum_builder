...
- `prompt_id`: `plan22.seed_population.v1`
...
- `authorized_inputs`: Governing v4 approach; previous-plan observations;
...
6. `SEED-T06 AUTHORITY_BOUNDARY` — No candidate controls decisive rubric,
   severity, thresholds, regression/holdout denominators, external results, or
   promotion.
