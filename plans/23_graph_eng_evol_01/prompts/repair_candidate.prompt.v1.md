...
- `prompt_id`: `plan23.repair_candidate.v1`
...
5. `REPAIR-T05 UNCHANGED_GENES` — Every non-invalidated gene hash equals the
   parent's hash.
6. `REPAIR-T06 AUTHORITY` — Child cannot change evaluation, corpus,
   standardized QA-gate, scoring, archive, or promotion authority.
