...
This v2 prompt supersedes the relocated v1 prompt and incorporates the independently reviewed postmortem v2.
...
1. `plans/26_langgraph_curriculum_factory/post_morten/postmortem.v2.md`
