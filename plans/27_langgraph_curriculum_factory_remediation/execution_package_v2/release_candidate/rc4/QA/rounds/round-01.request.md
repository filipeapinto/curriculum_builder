...
Path: /Users/filipepinto/Projects/curriculum_builder/plans/27_langgraph_curriculum_factory_remediation/execution_package_v2/release_candidate/rc4/rc4_review_bundle.v1.md
Version: round 1 of at most 1
SHA-256: 016ecbaad441620ad9695d720a7c48a94c5361018d794b967b17553fe784a97f
...
This is RC4 of the Run 27 execution-package-v2 N00 spec-approval gate. Focus on: (1) schema v2's approved_spec/approved_graph const-lock the CORRECT package-v2 artifacts, not the parent v1 package's; (2) contract v2 carries forward the exact already-approved digests/model decision from spec_approval.v1.yaml, not a reinvented approval; (3) the validator genuinely recomputes all five digests against live bytes, not just schema-shape; (4) N20/N30 prompt v5 are honest mechanical renames only; (5) the parent v1 schema and rc1/rc2/rc3 remain untouched.
